...
class UpdateOrders
{
    ...
    public function execute()
    {
        ...
        //$this->logger->info(__('Initialization of Update of Orders - Hiper Integration'));

        $this->helperIntegration->init(\AVDev\Hiper\Model\Integration\Method::GET_ORDERS);

        //$this->logger->info(__('Finalization of Update of Orders - Hiper Integration'));
    }
}
