...
class ImportUpdateProducts
{
    ...
    public function execute()
    {
        ...
        $this->logger->info(__('Initialization of Import and Update of Products - Sankhya Integration'));

        $this->helperIntegration->init(\TADev\Sankhya\Model\Integration\Method::IMPORT_UPDATE_PRODUCTS);

        $this->logger->info(__('Finalization of Import and Update of Products - Sankhya Integration'));
    }
}
